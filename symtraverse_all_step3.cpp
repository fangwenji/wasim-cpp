...
smt::TermVec tag2asmpt_c3(std::string flag, SymbolicExecutor & executor, smt::SmtSolver & solver){
    smt::TermVec ret;
...
int main(){
    ...
    std::unordered_set<std::string> base_sv = {"RTL_if_id_inst","RTL_if_id_valid",\
    ...
    std::string input_file =  PROJECT_SOURCE_DIR "/design/testcase3-four_stage_pipe1/problem_add.btor2";
